...
import 'package:google_maps_in_flutter/views/tela_configuracoes.dart'; // Certifique-se de importar a tela de configurações
      ...
      body: SingleChildScrollView( // Adiciona a rolagem
        ...
        child: Column(
          ...
          children: [
            ...
            metroLineCard('Linha Lilás', '12h / 20h - Bairro Josefino', 'Ativa', Colors.purple, context),
